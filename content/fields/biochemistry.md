...
parent_ids:
  - cell-theory
era_emerged: 1828 – 1961
core_question: What chemical reactions keep a cell alive, and how does it power them?
...
key_ideas:
  - term: Enzyme
    definition: >-
      A protein that speeds up a specific chemical reaction without being used up. Almost
      every reaction in a cell has its own enzyme.
    turning_point_id: sumner-urease
  - term: Metabolic pathway
    definition: >-
      A sequence of reactions, each catalysed by an enzyme, that turns one molecule into
      another in small steps. The citric acid cycle is the central one.
    turning_point_id: krebs-cycle
  - term: Enzyme kinetics
    definition: >-
      How fast an enzyme works as its substrate becomes more plentiful. The rate rises and
      then levels off when the enzyme is saturated, as Michaelis and Menten described.
    turning_point_id: michaelis-menten
  - term: ATP
    definition: >-
      Adenosine triphosphate, the cell's energy currency. Energy from food is used to make
      it, and breaking it down powers muscle, transport and synthesis.
    turning_point_id: chemiosmosis
  - term: Chemiosmosis
    definition: >-
      Cells store energy by pumping protons across a membrane, and use the flow back
      through a molecular turbine, ATP synthase, to make ATP.
    turning_point_id: chemiosmosis
...
turning_points:
  ...
  - id: buchner-cell-free
    ...
    description: >-
      ...
      of biochemistry. Buchner received the 1907 Nobel prize in chemistry.
    contested: false
    sources:
  ...
  - id: michaelis-menten
    date: "1913"
    type: DISCOVERY
    title: The kinetics of enzymes
    description: >-
      Leonor Michaelis and Maud Menten, a Canadian physician working in Berlin, measure how
      the speed of an enzyme reaction depends on the amount of substrate. The rate rises
      and then levels off as the enzyme becomes saturated, following a simple equation
      that assumes the enzyme first binds its substrate. It is still the starting point for
      describing how enzymes and drugs work.
    contested: false
    sources:
  ...
  - id: sumner-urease
    date: "1926"
    type: DISCOVERY
    title: An enzyme is a protein
    description: >-
      James Sumner, who had lost his left arm in a hunting accident and was told he could
      never be a chemist, crystallises the enzyme urease from jack beans after nine years
      of work, and shows that it is a protein. Enzymes were real chemical substances, and
      proteins could be catalysts. He shared the 1946 Nobel prize in chemistry.
    contested: true
    contested_note: >-
      Richard Willstätter, a Nobel laureate, argued that enzymes were small molecules
      carried on proteins, and that Sumner's crystals contained a trace of the true enzyme.
      His authority kept Sumner's result doubted until John Northrop crystallised several
  ...
  - id: krebs-cycle
    ...
    description: >-
      Hans Krebs, a refugee from Nazi Germany working in Sheffield, shows how cells burn the
      fragments of sugars, fats and proteins in a closed cycle of reactions, releasing
      carbon dioxide and capturing energy. *Nature* declined the paper, and it appeared in
      *Enzymologia*. The Krebs cycle is the hub of metabolism, and it won him the 1953 Nobel
      prize.
    contested: false
    sources:
      - citation: "Krebs, H. A. & Johnson, W. A. (1937). The role of citric acid in intermediate metabolism in animal tissues. Enzymologia 4: 148–156."
        url: null

  - id: chemiosmosis
    date: 1961 – 1978
    type: CONSENSUS-OVERTURNED
    title: Mitchell's chemiosmotic theory
    description: >-
      Biochemists searched for a high-energy chemical intermediate linking respiration to
      ATP production, and never found it. Peter Mitchell proposes instead that respiration
      pumps protons across the mitochondrial membrane, and that the protons flowing back
      drive ATP synthesis, as water drives a mill. The idea was ridiculed for a decade. He
      received the 1978 Nobel prize.
    contested: true
    contested_note: >-
      The "ox-phos wars" of the 1960s and 1970s were among the bitterest disputes in
      biochemistry. Mitchell, working from a private laboratory in a Cornish manor house,
      was opposed by most of the field, and some of his detailed proposals turned out to be
      wrong. The core idea is now universally accepted, but how much credit belongs to
...
open_problems:
  - id: de-novo-enzymes
    ...
    why_hard: >-
      ...
      Knowing how a protein folds is not the same as knowing how it catalyses.
    unlocks: >-
      Enzymes made to order for green chemistry, drug manufacture and breaking down
...
applications:
  ...
  - area: Physiology
    ...
    description: >-
      Cyanide kills by blocking the last enzyme of respiration, stopping the proton pumping
      that makes ATP. Biochemistry explains poisons, metabolic diseases and the energy
      budget of exercise in the same terms.
    sources:
...
In the early nineteenth century many chemists believed that the substances of living things could only be made by a vital force. In 1828 {{fig:friedrich-wohler|Friedrich Wöhler}} made urea, a substance from urine, by heating an ordinary salt. He wrote to his mentor Berzelius that he could make urea without needing a kidney. It did not end vitalism at once. But over the century chemists made more and more natural compounds in the laboratory, and the special status of living chemistry faded.

Fermentation was the test case. {{fig:louis-pasteur|Pasteur}} showed that it needs living yeast. Justus von Liebig insisted it was ordinary chemistry. In 1897 {{fig:eduard-buchner|Eduard Buchner}} settled it by grinding yeast with sand and filtering out every cell. The juice still turned sugar into alcohol. The work was done by substances in the cell, enzymes, and both men had been partly right.

## Enzymes

What were enzymes? In 1913 {{fig:leonor-michaelis|Leonor Michaelis}} and {{fig:maud-menten|Maud Menten}} described how fast they work, treating each enzyme as binding its target before transforming it. In 1926 {{fig:james-sumner|James Sumner}} crystallised the enzyme urease and showed it was a protein. The eminent chemist Richard Willstätter disputed it for years, but by the 1930s it was clear: enzymes are proteins, each shaped to catalyse one reaction.

Biochemists then traced how cells break down food. Sugar is split step by step, and in 1937 {{fig:hans-krebs|Hans Krebs}}, who had fled Nazi Germany, found the cycle of reactions in which the fragments are burned to carbon dioxide. Fritz Lipmann identified ATP as the molecule in which the energy is captured and spent. Every living thing, from bacteria to people, turned out to use the same core pathways.
...
$$
\frac{0.5 \times 8.4 \times 10^6 \text{ J}}{5 \times 10^4 \text{ J/mol}} \approx 84 \text{ mol of ATP per day} .
$$
...
By the 1950s biochemistry had also merged with genetics. The one gene–one enzyme idea tied genes to proteins, and [molecular biology](/biology/molecular-biology/) found how genes encode them. The structures of cell parts and how enzymes are organised in space became [cell biology](/biology/cell-biology/).
